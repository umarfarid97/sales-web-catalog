...
const MORE_ACCORDS = ['Amber', 'Aquatic', 'Aromatic', 'Citrus', 'Oud', 'Sweet'];
      ...
      <main style={{ flex: 1, paddingBottom: '5rem' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '1.25rem clamp(12px, 3.5vw, 24px)' }}>
          ...
          {isSearchOpen && (
            <div style={{
              ...
              <input
                type="text"
                autoFocus
                placeholder="Search men's perfumes by name, brand inspiration, notes (e.g. Sauvage, Bergamot)..."
                value={searchQuery}
          ...
          <Pagination
            ...
            itemLabel="men's creations"
            scrollTargetId="men-catalog-grid"
          />
